...
pub const rectangle_vertices = [][3]c.GLfloat {
...
pub const rectangle_uv = [][2]c.GLfloat{
    []c.GLfloat{0, 0},
    []c.GLfloat{0, 1},
    []c.GLfloat{1, 0},
    []c.GLfloat{1, 1},
...
pub const triangle_vertices = [][3]c.GLfloat {
    []c.GLfloat{0.0, 0.0, 0.0},
    []c.GLfloat{0.0, 1.0, 0.0},
    []c.GLfloat{1.0, 0.0, 0.0},
};

pub const triangle_uv = [][2]c.GLfloat{
    []c.GLfloat{0, 0},
    []c.GLfloat{0, 1},
    []c.GLfloat{1, 0},
};
...
pub fn tile(
  ...
  std.mem.copy(
    ...
    texcoord2f,
    switch (transform) {
      Draw.Transformation.Identity =>
        [8]f32{s0, t0, s0, t1, s1, t1, s1, t0},
      Draw.Transformation.FlipVertical =>
        [8]f32{s0, t1, s0, t0, s1, t0, s1, t1},
      Draw.Transformation.FlipHorizontal =>
        [8]f32{s1, t0, s1, t1, s0, t1, s0, t0},
      Draw.Transformation.RotateClockwise =>
        [8]f32{s0, t1, s1, t1, s1, t0, s0, t0},
      Draw.Transformation.RotateCounterClockwise =>
