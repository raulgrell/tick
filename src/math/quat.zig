...
pub fn QuatT(comptime T: type) type {
    return struct {
        ...
        pub fn scale(self: *const Self, scalar: T) void {
        ...
        pub fn rotationVector(unitVec0: *const Vec3T(T), unitVec1: *const Vec3T(T)) Self {
        ...
        pub fn rotationAngle(radians: f32, unitVec: *const Vec3) Self {
            const angle = radians / 2;
        ...
        pub fn select(first: *const Self, second: *const Self, select_second: bool) Self {
            return quat(
